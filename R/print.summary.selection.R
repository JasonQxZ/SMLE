#' Print a summary of selection object
#'
#' @description This function prints a summary of a selection object.
#' In particular, it shows the features retained after SMLE-selection.
#'
#' @param object Fitted '\code{seleciton}' object.
#'
...
#' summary(fit)
#'
print.summary.selection<- function(object, ...){
